 ...
 * @public
 */
export declare interface EditorPlugin<S extends StateType = StateType, Config extends {} = {}> {
    /**
 ...
 * @public
 */
export declare interface EditorPluginProps<S extends StateType = StateType, Config extends {} = {}> {
    /**
     * Plugin configuration
     */
    config: Config;

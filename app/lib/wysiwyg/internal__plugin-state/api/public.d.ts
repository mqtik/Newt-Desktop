 ...
 * @public
 */
export declare interface FocusableChild {
    /**
     * Id of the document
     */
    id: string;
...
/** @public */
export declare interface PluginProps {
    config?: {};
 ...
 * @public
 */
export declare interface StateType<S = any, T = any, R = any> {
    /**
 ...
 * @public
 */
export declare type StateTypeSerializedType<D extends StateType> = D extends StateType<infer S> ? S : never;
 ...
 * @public
 */
export declare interface StoreDeserializeHelpers<K extends string = string, S = unknown> {
    /**
 ...
 * @public
 */
export declare interface StoreSerializeHelpers<K extends string = string, S = unknown> {
    /**

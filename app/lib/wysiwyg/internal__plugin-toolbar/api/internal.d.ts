 ...
 * @beta
 */
export declare interface OverlayButtonProps {
    className?: string;
 ...
 * @beta
 */
export declare interface OverlayCheckboxProps {
    checked?: boolean;
 ...
 * @beta
 */
export declare interface OverlayInputProps extends React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> {
    label: string;
}
 ...
 * @beta
 */
export declare interface OverlaySelectProps extends React.DetailedHTMLProps<React.SelectHTMLAttributes<HTMLSelectElement>, HTMLSelectElement> {
    label: string;
    options: string[];
    width?: string;
}
 ...
 * @beta
 */
export declare interface OverlayTextareaProps extends React.DetailedHTMLProps<React.TextareaHTMLAttributes<HTMLTextAreaElement>, HTMLTextAreaElement> {
    label: string;
}
 ...
 * @beta
 */
export declare interface PluginToolbar {
 ...
 * @beta
 */
export declare interface PluginToolbarButtonProps {
    className?: string;
 ...
 * @beta
 */
export declare interface PluginToolbarOverlayButtonProps {
    className?: string;

...
class Importer extends Component<Props> {
	constructor(props){
		super(props);
							    ...
							    content={({ position, targetRect, popoverRect }) => (
							        ...
							        >
							            ...
							            >
								            ...
								            <Dropzone className={'dimensionsEpubImportDrop'} 
								            	multiple={false}
                  								accept="application/epub+zip"
								            	onDrop={(files) => this.onDropEpubs(files)}>
								            	<li>
								            		<Icon
																			  name='book'
																			  font='MaterialCommunityIcons'
																			  ...
																			  // style={{}}
																			/><br/>
													{this.state.isImporting == false && <span>Drop epubs<br />or press to select</span>}
							...
							/>
				  				...
				  				<div className="search">
								    ...
								    <div className="field">
								      ...
								      <input type="text" autoFocus onChange={(e) => this.props.onTypeSearch(e)} placeholder="Search" className="input-search" id="input-search" onKeyDown={this.props._handleKeyDown} name="input-search" required />
	 ...
	 _renderCoreSidebar = () => {
	 	return (
	 		<div style={{display: 'inline-flex'}}>
						...
						<Importer onDropEpubs={(files) => this.props.onDropEpubs(files)} onCreateWork={(e) => this.props.onCreateWork(e)}/>
						...
						<Popover
							...
							<div style={{display: 'inline-flex'}} onClick={() => this.setState({ isPopoverUserOpen: !this.state.isPopoverUserOpen })} >
							    <div 
	...
	render(){
	 ...
	 if(this.props.openedFiles && typeof this.props.openedFiles === 'object' && this.props.selectedTab != null && this.props.openedFiles[this.props.selectedTab]){
	 	...
	 	if(this.props.openedFiles[this.props.selectedTab].type == 'bulk'){
	 		...
	 		return (
	 			...
	 			<div className={'bulkTitleEditor'}>
	 				<h3 className={'truncate'} style={{margin:10}}>
	 					{
	 	...
	 	return (
	  	...
	  	<div style={{display: 'inline-flex', height: 100, width: '100%', height: 68}}>
	  	<ContextMenuArea menuItems={itemsAdd} width={200}>
	    ...
	    <div style={{ display: 'inline-flex',    justifyContent: 'flex-end', alignItems: 'flex-end', position: 'absolute', right: 10}}>
	  		...
	  		<div key={'save'+this.props.openedFiles[this.props.selectedTab]._id} className={['toolbarButtonTitleEditor'].join(" ")}>
	  			<ContextMenuArea menuItems={itemsSettings} width={200}>

	...
	_renderAdd = (key) => {
		...
		return (
			<ContextMenuArea menuItems={itemsAdd}>
			  	<button className={['badge'].join(' ')} style={{height:'32px',border: 0}}>
					<span>Add</span>
				</button>
		    </ContextMenuArea>
		);
									...
									<div className={'flexBookSettings'}>
										...
										<div className={'flexBookSettingsSubBar'}>
											...
											<ToggleDisplay if={typeof this.state.book.author == 'string'}>
												<div className={['badge', 'badgeSubBar'].join(" ")} style={{ padding: '2px 10px 8px',height: '22px', display: 'inherit'}} onClick={() => this.showField(this.state.book, 'author')}>
													<span>
											...
											<div className={['badge', 'badgeSubBar'].join(" ")} style={{ padding: '2px 10px 8px',height: '22px', display: 'inherit'}} onClick={() => this.showField(this.state.book, 'tags')}>
												<span>
											...
											<ToggleDisplay if={typeof this.state.book.picked !== 'undefined' && this.state.book.picked != false} onClick={() => this.setPicked(this.state.book)}>
									            	<div className={['badge', 'badgeSubBar'].join(" ")} style={{ padding: '2px 10px 8px',height: '22px', display: 'inherit'}}>
														<span>
															Picked
														</span>
													</div>
